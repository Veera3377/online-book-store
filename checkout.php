	...
	<div class="container">
			...
			<table class="timetable_sub">
				<thead>
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="single.html"><img src="images/a6.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert">Computer Networking</td>
						<td class="invert">₹2000</td>
		...
		<div class="checkout-left">	
				...
				<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
					<a href="purchase.php"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Back To Shopping</a>
				</div>
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					<h4>Shopping basket</h4>
					<ul>
						<li>Computer Networks <i>-</i> <span>₹2000</span></li>
						<li>Total <i>-</i> <span>₹2000</span></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<div class="footer">
	<div class="container">
		...
		<div class="clearfix"></div>
		<!--<p class="copy-right">&copy 2016 BookStore. All rights reserved | Design by Shruti.K, Tuhina, Sushma.S</p>-->
	</div>
</div>
<!-- //footer -->
<!-- login -->
